...
var job = {
	...
	"other" : [ "we do retreats", "we change the world", "best team around",
			"hardcore", ],
	"misc" : {
		"training" : TrainingType().Informal,
		"fossphilosophy" : FOSS().AlwaysOpen,
		"codingretreats" : true,
		"conferences" : [ ConferencePotential().Speaking,
		...
		"kitchen" : true,
		"canteen" : false,
		"freestuff" : [ "coffee", "beverages", "snacks", "bikeparking",
				"playroom" ],
	}
}
...
function CompanySize() {
	return enumerate("LessThanTen", "TenToTwenty", "TwentyToFifty",
			"FiftyToTwoHundred", "MoreThanTwoHundred");
}
